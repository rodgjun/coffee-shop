...
<div class="row">
	<div class='box box-solid'>
	  	...
	  	<div class='box-body'>
	    	<a href="https://www.facebook.com/communitycoffeeph" class="btn btn-social-icon btn-facebook"><i class="fa fa-facebook"></i></a>
	    	<a class="btn btn-social-icon btn-twitter"><i class="fa fa-twitter"></i></a>
	    	<a href="https://www.instagram.com/communitycoffeeph/" class="btn btn-social-icon btn-instagram"><i class="fa fa-instagram"></i></a>
	  	</div>
	</div>
</div>
